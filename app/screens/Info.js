          ...
          <View style={{ padding: 30 }}>
            <View style={{ paddingBottom: 20 }}>
              ...
              <Text>
                ...
                and sometimes without any apparent reason. Depression is more
                than just a low mood – it's a serious condition that affects
            ...
            <View style={{ paddingBottom: 20 }}>
              ...
              <Text style={{ paddingBottom: 15 }}>
                Depression usually results from a combination of recent events
                and other longer-term or personal factors, rather than one
                immediate issue or event.
              </Text>
              <Text>
                Family history – Depression can run in families and some people
                will be at an increased genetic risk.
              </Text>
              <Text>
                Personality – Some people may be more at risk of depression
                because of their personality, particularly if they have a
                tendency to worry a lot, have low self-esteem.
              </Text>
              <Text>
                Drug and alcohol use – Drug and alcohol use can both lead to and
                result from depression. Many people with depression also have
            ...
            <View>
              <View style={{ paddingTop: 20 }}>
                ...
                <Text style={{ paddingVertical: 10 }}>
                  ...
                  'depression'. It involves low mood.
                </Text>
                ...
                <Text style={{ paddingVertical: 10 }}>
                  ...
                  (a mild to moderate level of mania).
                </Text>
                ...
                <Text style={{ paddingVertical: 10 }}>
                  SAD is a mood disorder that has a seasonal pattern. The cause
                  of the disorder is unclear, but it's thought to be related to
                  the variation in light exposure in different seasons.
                </Text>
              </View>
            </View>
          </View>
